...
newTrial("end",
    newText("You have just completed the first part of the experiment.")
        ...
        .print()
    ,
    newText("<p>If you need to take a break, do so now before proceeding to part two.</p>")
        .center()
        .print()
    ,
    newText("<p><a href='https://expt.pcibex.net/ibexexps/mcmoyer11/BN_B/experiment.html'>Click here for Part 2/3.</a></p>")
        .center()
        .print()
    ,
    newButton("void")
